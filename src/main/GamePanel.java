...
public class GamePanel extends JPanel implements Runnable {
    ...
    public GamePanel() {
        ...
        setBackground(new Color(4, 4, 66));
...
// BLACK TEAM
            ...
            if (mouse.pressed == false) {
                ...
                if (activeP != null) {
                    ...
                    if (validSquare) {
                        ...
                        //Update the pieces list in case a piece has been captured and remove during simulation
                        ...
                        //THE MOVE CANCELED RESET EVERYTHING
                        copyPieces(pieces, simPieces);
    ...
    private void simulate() {
        ...
        //if a pieces is being held, update its position
        activeP.x = mouse.x - HALF_SQUARE_SIZE;
        activeP.y = mouse.y - HALF_SQUARE_SIZE;
        ...
        if (activeP != null) {
            if (canMove) {
                if (isIllegal(activeP) ||  opponentCanCaptureKing()) {
                    g2.setColor(new Color(255, 25, 25, 255));
                    g2.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 0.7f));// will blur white indicate pickup
                    g2.fillRect(activeP.col * Board.SQUARE_SIZE, activeP.row * Board.SQUARE_SIZE, Board.SQUARE_SIZE, Board.SQUARE_SIZE);
                    g2.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 1f)); //revert back to white
                } else {
            ...
            //draw activeP on the end so it won't be hidden by the board or the colored square
            activeP.draw(g2);
        }
